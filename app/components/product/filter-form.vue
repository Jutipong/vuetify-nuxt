        ...
        <VCardText>
            <VRow>
                <VCol cols="12" md="4">
                    ...
                    <!-- <VueTelInput v-model="phone" mode="international" /> -->
                </VCol>
            ...
            <VRow>
                ...
                <VCol cols="12" md="4">
                    <VDate
                        ...
                        :locale_multiple="true"
                        :max="state.search.end"
                        label="Start Date"
                    />
                </VCol>
            ...
            <VRow>
                <VCol cols="12" md="4">
                    <VAutocompleteServer
                        v-model="state.search.autoCompleteServer"
                ...
                <VCol cols="12" md="6">
                    <VAutocompleteMultipleServer
                        v-model="state.search.autoCompleteMultipleServer"
            ...
            <VRow>
                ...
                <VCol cols="12" md="4">
                    dateString: {{ state.search.dateString }}
                    <br>
                    dateStringDisplay:{{ state.search.dateStringDisplay }}
                    <VDateString
                        v-model:string="state.search.dateStringDisplay"
                        :clearable="true"
                        label="Date String"
                        :locale_multiple="true"
                    />
